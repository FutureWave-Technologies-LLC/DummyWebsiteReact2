...
function ProfilePage() {
    ...
    useEffect(() => {
        ...
        // Fetch user's data
        axios.get("https://d1ls0cg8xyipo0.cloudfront.net/users/get_user_data/", {
        ...
        .then((response) => {
            if (response.data.error === false) {
                ...
                // Fetch followers
                axios.get("https://d1ls0cg8xyipo0.cloudfront.net/profiles/get_followers/", {
                ...
                axios.get("https://d1ls0cg8xyipo0.cloudfront.net/profiles/get_followees/", {
                    params: { user_id: response.data.user_id },
                })
                .then(response => {
