...
function ProfilePage() {
    ...
    useEffect(() => {
        ...
        // Fetch user's data
        axios.get("http://18.219.191.19:8000/users/get_user_data/", {
        ...
        .then((response) => {
            if (response.data.error === false) {
                ...
                // Fetch followers
                axios.get("http://18.219.191.19:8000/profiles/get_followers/", {
                ...
                axios.get("http://18.219.191.19:8000/profiles/get_followees/", {
                    params: { user_id: response.data.user_id },
                })
                .then(response => {
