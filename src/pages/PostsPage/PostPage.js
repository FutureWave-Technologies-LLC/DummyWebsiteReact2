...
function PostPage() {
    ...
    useEffect(() => {
        ...
        axios.get("https://d1ls0cg8xyipo0.cloudfront.net/posts/post/", {
    ...
    function getLikes() {
        ...
        axios.get("https://d1ls0cg8xyipo0.cloudfront.net/posts/likes/", {
            params: { post_id: postId,
    ...
    const handleLike = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://d1ls0cg8xyipo0.cloudfront.net/posts/likes/', {
                post_id: postId,
                user_id: token.user_id
            })
            getLikes()
